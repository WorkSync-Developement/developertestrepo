...
import ModernAboutPage from '@/components/variants/modern/about/AboutPage';
...
export default async function LocationAboutPage({ params }: PageProps) {
  ...
  const [websiteData, clientData, businessInfo, variant] = await Promise.all([
    getWebsiteBySlug(slug),
    getClientData(),
    getBusinessInfo(),
    getTemplateVariant(),
    ...
    return (
      <>
        <ModernAboutPage
          ...
          localKnowledgeSection={localKnowledgeSection}
          personalApproachSection={personalApproachSection}
